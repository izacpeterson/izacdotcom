...
export default function NavMenu() {
  return (
    <div className="flex flex-col items-center h-screen shadow-xl bg-zinc-800">
      ...
      <span className="text-center text-5xl text-green-500 font-bold p-4">Izac</span>
      <nav className="flex flex-col h-full justify-center">
        <Link href="/projects" className="p-4  hover:text-green-500 transition-all duration-200">
          Projects
        </Link>
        <Link href="/projects" className="p-4  hover:text-green-500 transition-all duration-200">
          Skills
